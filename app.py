...
if st.sidebar.button("Predict Price"):
    ...
    # One-hot encoding
    if f'fuel_{fuel}' in columns:
        input_df[f'fuel_{fuel}'] = 1

    if f'seller_type_{seller}' in columns:
        input_df[f'seller_type_{seller}'] = 1

    if transmission == "Manual" and 'transmission_Manual' in columns:
        input_df['transmission_Manual'] = 1

    if owner != "First Owner" and f'owner_{owner}' in columns:
        input_df[f'owner_{owner}'] = 1

    if f'name_{brand}' in columns:
